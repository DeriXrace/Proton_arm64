...
#elif (defined(__i386__) || defined(__x86_64__)) && !defined(_M_ARM64EC)
...
{
#if (defined(__x86_64__) || defined(__i386__)) && !defined(_M_ARM64EC)
    for (;;) __asm__ __volatile__( "int $0x29" :: "c" ((ULONG_PTR)code) : "memory" );
#elif defined(__aarch64__) || defined(_M_ARM64EC)
